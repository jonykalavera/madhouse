return {
	...
	},
	{
		...
		-- 		vim.keymap.set("n", "<Leader>ccc", "<cmd>CodeCompanionToggle<cr>", opts("Toggle Code Companion"))
		-- 		vim.keymap.set("v", "<Leader>ccc", "<cmd>CodeCompanionToggle<cr>", opts("Toggle Code Companion"))
		-- 		vim.keymap.set("v", "<Leader>cga", "<cmd>CodeCompanionAdd<cr>", opts("Add to Code Companion"))
		--
